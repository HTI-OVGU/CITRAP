...
import_files -fileset constrs_1 -force -norecurse /dummy_path/partition.xdc
...
update_compile_order -fileset sources_1
open_bd_design {/dummy_path/citrap/citrap.srcs/sources_1/bd/static_design/static_design.bd}
open_bd_design {/dummy_path/citrap/citrap.srcs/sources_1/bd/static_design/static_design.bd}
