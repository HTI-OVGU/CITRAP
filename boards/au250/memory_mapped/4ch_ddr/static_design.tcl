...
proc create_hier_cell_pcie_conf { parentCell nameHier } {
  ...
  connect_bd_net -net X9032_dout  [get_bd_pins X9032/dout] \
  [get_bd_pins dev_id]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: rst_ddr4_2_300M, and set properties
  ...
  # Create instance: rst_ddr4_3_300M, and set properties
  ...
  connect_bd_intf_net -intf_net axi_smc_1_M02_AXI [get_bd_intf_pins axi_smc_1/M02_AXI] [get_bd_intf_pins ddr4_2/C0_DDR4_S_AXI_CTRL]
  connect_bd_intf_net -intf_net axi_smc_1_M03_AXI [get_bd_intf_pins axi_smc_1/M03_AXI] [get_bd_intf_pins ddr4_3/C0_DDR4_S_AXI_CTRL]
  ...
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins ddr4_2/C0_DDR4_S_AXI]
  connect_bd_intf_net -intf_net axi_smc_M04_AXI [get_bd_intf_pins axi_smc_1/S00_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M04_AXI1 [get_bd_intf_pins axi_smc/M04_AXI] [get_bd_intf_pins ddr4_3/C0_DDR4_S_AXI]
  ...
  [get_bd_pins rst_ddr4_3_300M/ext_reset_in] \
  [get_bd_pins rst_ddr4_1_300M/ext_reset_in] \
  [get_bd_pins rst_ddr4_2_300M/ext_reset_in]
  ...
  connect_bd_net -net rst_ddr4_2_300M_peripheral_aresetn  [get_bd_pins rst_ddr4_2_300M/peripheral_aresetn] \
  [get_bd_pins ddr4_2/c0_ddr4_aresetn]
  connect_bd_net -net rst_ddr4_3_300M_peripheral_aresetn  [get_bd_pins rst_ddr4_3_300M/peripheral_aresetn] \
  ...
  assign_bd_address -offset 0x001400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x80100000 -range 0x00100000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP_CTRL/C0_REG] -force
  ...
  assign_bd_address -offset 0x001800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI] [get_bd_addr_segs ddr4_2/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x80300000 -range 0x00100000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI] [get_bd_addr_segs ddr4_2/C0_DDR4_MEMORY_MAP_CTRL/C0_REG] -force
  assign_bd_address -offset 0x001C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI] [get_bd_addr_segs ddr4_3/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x80400000 -range 0x00100000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI] [get_bd_addr_segs ddr4_3/C0_DDR4_MEMORY_MAP_CTRL/C0_REG] -force
  ...
  assign_bd_address -offset 0x001800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sstatic_axi_0] [get_bd_addr_segs ddr4_2/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x80300000 -range 0x00100000 -target_address_space [get_bd_addr_spaces sstatic_axi_0] [get_bd_addr_segs ddr4_2/C0_DDR4_MEMORY_MAP_CTRL/C0_REG] -force
  assign_bd_address -offset 0x001C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sstatic_axi_0] [get_bd_addr_segs ddr4_3/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x80400000 -range 0x00100000 -target_address_space [get_bd_addr_spaces sstatic_axi_0] [get_bd_addr_segs ddr4_3/C0_DDR4_MEMORY_MAP_CTRL/C0_REG] -force
