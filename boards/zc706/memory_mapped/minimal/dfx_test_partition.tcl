...
################################################################
# This is a generated script based on design: reconf_partition
#
...
# source reconf_partition_script.tcl
...
connect_bd_intf_net -intf_net [get_bd_intf_nets S_AXI_0_1] [get_bd_intf_ports mstatic_axi_0] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI [get_bd_intf_pins axi_dma_0/M_AXI] [get_bd_intf_pins smartconnect_1/S00_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_1_M00_AXI] [get_bd_intf_ports sstatic_axi_0] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  assign_bd_address -offset 0x40000000 -range 0x40000000 -with_name SEG_M00_AXI_0_Reg -target_address_space [get_bd_addr_spaces axi_dma_0/Data] [get_bd_addr_segs sstatic_axi_0/Reg] -force
  ...
  assign_bd_address -offset 0x00001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces mstatic_axi_0] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
